...
public class RefreshableViewNested extends LinearLayout implements View.OnTouchListener {
     ...
     * @param attrs
     */
    public RefreshableViewNested(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && !loadOnce) {
            ...
            listView = (NestedScrollView) getChildAt(1);
